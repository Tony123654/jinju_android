...
import com.jinju.android.api.IncreaseProgressBar;
...
import com.jinju.android.dialog.CalculatorDialog;
...
public class FinancialDetailActivity extends BaseFragmentActivity implements InvestRecordFragment.InvestRecordListener, View.OnClickListener {
    ...
    private IncreaseProgressBar mMagicProgressBar;
    ...
    private RelativeLayout projectIntroduce;
    private RelativeLayout contractImg;
    private RelativeLayout repaymentSource;
    ...
    private void initView() {
        ...
        findViewById(R.id.ivBack).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(FinancialDetailActivity.this, LoanActivity.class));
                finish();
            }
        });

//        layout = getLayoutInflater().inflate(R.layout.loan_detail, null);
//
//         tvTitle = (TextView) layout.findViewById(R.id.tv_project_title);

        //        mTxtTitle = (TextView) layout.findViewById(R.id.tv_product_title);
...
//        layout = getLayoutInflater().inflate(R.layout.loan_detail, null);
        ...
        tvTitle = (TextView) findViewById(R.id.tv_project_title);
...
//                mTxtAddInterest = (TextView)layout.findViewById(R.id.txt_add_interest);
//        mTxtLeastAmount = (TextView) findViewById(R.id.txt_least_amount);
                ...
                mMagicProgressBar = (IncreaseProgressBar) findViewById(R.id.progress_bar);
        txtProgress = (TextView) findViewById(R.id.txt_progress);

        rePayment = (TextView) findViewById(R.id.project_back_type);

         startTime = (TextView) findViewById(R.id.project_start_time);
         endTime   = (TextView) findViewById(R.id.project_end_time);

        investRecord     = (RelativeLayout) findViewById(R.id.txt_record_desc);
        projectIntroduce = (RelativeLayout) findViewById(R.id.relayout_introduce);
        contractImg      = (RelativeLayout) findViewById(R.id.relayout_img);
        repaymentSource  = (RelativeLayout) findViewById(R.id.layout_back_money);
         buyCount = (TextView) findViewById(R.id.project_buy_count);
        ...
        //
                mBtnFinancial = (TextView) findViewById(R.id.tv_detail_buy);
        //        mTxtFinancial = (TextView) findViewById(R.id.txt_financial);
//                mIvCountDown = (ImageView) findViewById(R.id.iv_count_down);
        iv_detail_calc1 = (ImageView) findViewById(R.id.iv_detail_calc1);
        mBtnFinancial.setOnClickListener(mBtnFinancialOnClickListener);
        iv_detail_calc1.setOnClickListener(this);
        investRecord.setOnClickListener(this);
        projectIntroduce.setOnClickListener(this);
//        contractImg.setOnClickListener(this);
        repaymentSource.setOnClickListener(this);
        //        //包标返现
...
//                    animationDrawable.stop();
//                }
                tvTitle.setText(financialDetail.getName());
                buyCount.setText(financialDetail.getOrderCount()+"");
                //
...
//
////                mTxtLeastAmount.setText("起投金额"+financialDetail.getLoanPeriodDesc()+"元");
//                    mTxtLeastAmount.setText("起投金额100元起");
//                }
...
//                mMagicProgressBar.setProgressWithOutAnim(percent);
                mMagicProgressBar.setProgress(percent);
                                setAnimation(percent);

//                                setCountRecord(mFinancialDetail.getOrderCount());
//                mTxtLoanPeriod.setText(financialDetail.getLoanPeriodDesc());
////                mTxtLeastAmount.setText(financialDetail.getLeastBuy());
                ...
                startTime.setText(financialDetail.getSubscribeBeginTime());
                endTime.setText(financialDetail.getEndDate());
...
//                mTxtEndgameCup.setText(Html.fromHtml(TextShowUtils.colorHtmlText(mAwardInfoList.getEndingDesc())));
    ...
    public static int getPrcess(long collMoney, long money) {
        if (money <= 0)
            return 0;
        else
            return (int) ((collMoney * 100 / money));
    }


    public static int getPrcess(double collMoney, double money) {
        if (money <= 0)
            return 0;
        else
            return (int) ((collMoney * 100 / money));
...
//                startActivity(new Intent());
            ...
            case R.id.iv_detail_calc1:
                CalculatorDialog dialog = new CalculatorDialog(FinancialDetailActivity.this, mFinancialDetail);
                dialog.show();
                break;
            case R.id.txt_record_desc:
                startActivity(new Intent(this,InvestRecordActivity.class));
                break;

            case R.id.relayout_introduce:
                startActivity(new Intent(this,BaseJsBridgeWebViewActivity.class));

            case R.id.layout_back_money:
