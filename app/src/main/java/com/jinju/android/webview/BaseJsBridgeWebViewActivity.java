...
public class BaseJsBridgeWebViewActivity extends BaseActivity {
    ...
    private String mUrl;
    private Boolean isAdvertView;//是否在广告界面
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUrl = getIntent().getStringExtra(EXTRA_URL_PATH);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case MODAL:
                    if (eventTouch) {
                        eventTouch = false;
                        ModelDialog.showModelDialog(BaseJsBridgeWebViewActivity.this, jsModalInfo, new ModelDialog.DialogListener() {
                            @Override
                ...
                case SHARE_DIALOG:
                    ...
                    mShareDialog.showShareDialog(BaseJsBridgeWebViewActivity.this,mShareInfo);
                    break;
            }
        }
    };
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        //图片上传的回调
        EasyImage.handleActivityResult(requestCode,resultCode,data,BaseJsBridgeWebViewActivity.this, new DefaultCallback(){
            @Override
    ...
    private void initViewData() {
        ...
        mWebView.setWebViewClient( new MyWebViewClient(mWebView,this,txtTitle));
        //不使用缓存，只从网络获取数据.
        ...
        mWebView.registerHandler("getPhoneCall", new BridgeHandler() {
            ...
            public void handler(String data, CallBackFunction function) {
                ...
                try {
                    ...
                    UIHelper.callPhoneWindow(BaseJsBridgeWebViewActivity.this, "拨打电话",
        ...
        */
        mWebView.registerHandler("login", new BridgeHandler() {
            ...
            public void handler(String data, CallBackFunction function) {
                ...
                try {
                    ...
                    //没有登录去登陆窗口
                    Intent intent = new Intent(BaseJsBridgeWebViewActivity.this, LoginInAdvanceActivity.class);
        ...
        mWebView.registerHandler("sendToastMsg", new BridgeHandler() {
            ...
            public void handler(String data, CallBackFunction function) {
                try {
                    ...
                    AppUtils.showToast(BaseJsBridgeWebViewActivity.this,message);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
        ...
        mWebView.registerHandler("openView", new BridgeHandler() {
            ...
            public void handler(String data, CallBackFunction function) {
                try {
                    ...
                    UIHelper.showJsBridgeWebViewActivity(BaseJsBridgeWebViewActivity.this,url);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
        ...
        mWebView.registerHandler("callForNetworkState", new BridgeHandler() {
            ...
            public void handler(String data, CallBackFunction function) {
                    ...
                    int state = NetworkUtil.getNetType(BaseJsBridgeWebViewActivity.this);
        ...
        mWebView.registerHandler("selectSingleImage", new BridgeHandler() {
            ...
            public void handler(String data, CallBackFunction function) {
                ...
                if (jsonObject != null) {
                    //弹出窗口
                    GetPicDialog.initDialog(BaseJsBridgeWebViewActivity.this);
                }
            }
        });
    }
