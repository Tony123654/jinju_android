...
public class SlidingTabStrip extends HorizontalScrollView {
    ...
    public void setTabContent(List<About> list) {
        this.list = list;
    ...
    public void notifyDataSetChanged(){
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            addTextTab(i, list.get(i).getTitle());
    ...
    static class SavedState extends BaseSavedState {
        ...
        public static final Parcelable.Creator<SlidingTabStrip.SavedState> CREATOR = new Parcelable.Creator<SlidingTabStrip.SavedState>() {
            @Override
