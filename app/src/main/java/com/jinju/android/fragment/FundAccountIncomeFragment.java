...
public class FundAccountIncomeFragment extends BaseFragment{

    private String mLogType = AccountLogType.RECHARGE;
    ...
    private FundAccountIncomeCallBack fundAccountIncomeCallBack;
    ...
    public void onAttach(Context context) {
        ...
        fundAccountIncomeCallBack = (FundAccountIncomeCallBack)context;
        ((FundAccountActivity)context).setOnIncomeSelectTagListener(mOnIncomeSelectTagListener);
    }
    @Override
    ...
    private UserManager.OnGetFundAccountLogListFinishedListener mOnGetFundAccountLogListFinishedListener = new UserManager.OnGetFundAccountLogListFinishedListener() {
        ...
        public void onGetFundAccountLogListFinished(Response response, AccountLogInfo accountLogInfo) {
            if (response.isSuccess()) {
                ...
                fundAccountIncomeCallBack.fundAccountIncomeValue(mCodeList);
    ...
    private FundAccountActivity.OnIncomeSelectTagListener mOnIncomeSelectTagListener = new FundAccountActivity.OnIncomeSelectTagListener() {
        @Override
        public void onIncomeSelectTag(int selectTag) {
