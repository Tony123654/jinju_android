...
public class FundAccountFreezeFragment extends BaseFragment{
    ...
    private FundAccountFreezeCallBack fundAccountFreezeCallBack;
    ...
    public void onAttach(Context context) {
        ...
        fundAccountFreezeCallBack = (FundAccountFreezeCallBack)context;
        ((FundAccountActivity)context).setOnFreezeSelectTagListener(mOnFreezeSelectTagListener);
    }
    @Override
    ...
    private UserManager.OnGetFundAccountLogListFinishedListener mOnGetFundAccountLogListFinishedListener = new UserManager.OnGetFundAccountLogListFinishedListener() {
        ...
        public void onGetFundAccountLogListFinished(Response response, AccountLogInfo accountLogInfo) {
            if (response.isSuccess()) {
                ...
                fundAccountFreezeCallBack.fundAccountFreezeValue(mCodeList);
    ...
    private FundAccountActivity.OnFreezeSelectTagListener mOnFreezeSelectTagListener= new FundAccountActivity.OnFreezeSelectTagListener() {
        @Override
        public void onFreezeSelectTag(int selectTag) {
